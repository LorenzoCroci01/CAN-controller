...
REM
REM Generated by Vivado on Mon Dec 15 15:30:02 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_top_level_tx_vhdl.prj"
call xvhdl  --incr --relax -prj tb_top_level_tx_vhdl.prj -log xvhdl.log
