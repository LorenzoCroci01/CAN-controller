...
#
# Script generated by Vivado on Wed Jan 07 16:33:27 +0100 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_tx_83bit.sh
...
#
# Usage        : fifo_tx_83bit.sh
#                fifo_tx_83bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_tx_83bit.sh [-reset_run]
#                fifo_tx_83bit.sh [-reset_log]
#                fifo_tx_83bit.sh [-help]
#
...
# script info
echo -e "fifo_tx_83bit.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_tx_83bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_tx_83bit xil_defaultlib.fifo_tx_83bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_tx_83bit -key {Behavioral:sim_1:Functional:fifo_tx_83bit} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_tx_83bit.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_tx_83bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_tx_83bit.sh [-help]\n\
Usage: fifo_tx_83bit.sh [-step]\n\
Usage: fifo_tx_83bit.sh [-lib_map_path]\n\
Usage: fifo_tx_83bit.sh [-reset_run]\n\
Usage: fifo_tx_83bit.sh [-reset_log]\n\
Usage: fifo_tx_83bit.sh [-keep_index]\n\
Usage: fifo_tx_83bit.sh [-noclean_files]\n\n\
