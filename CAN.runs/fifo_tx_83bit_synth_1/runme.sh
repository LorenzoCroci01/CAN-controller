...
HD_PWD='C:/Users/croci/CAN/CAN.runs/fifo_tx_83bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_tx_83bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_tx_83bit.tcl
