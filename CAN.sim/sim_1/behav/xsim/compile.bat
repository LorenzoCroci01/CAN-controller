...
REM
REM Generated by Vivado on Tue Nov 25 14:58:00 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_top_level_RX_vhdl.prj"
call xvhdl  --incr --relax -prj tb_top_level_RX_vhdl.prj -log xvhdl.log
