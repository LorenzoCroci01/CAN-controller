...
REM
REM Generated by Vivado on Mon Nov 10 16:45:31 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_CAN_RX_Top_vhdl.prj"
call xvhdl  --incr --relax -prj tb_CAN_RX_Top_vhdl.prj -log xvhdl.log
