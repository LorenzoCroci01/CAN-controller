...
REM
REM Generated by Vivado on Fri Nov 14 16:16:09 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_CAN_RX_module_vhdl.prj"
call xvhdl  --incr --relax -prj tb_CAN_RX_module_vhdl.prj -log xvhdl.log
