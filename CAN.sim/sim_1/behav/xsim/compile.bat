...
REM
REM Generated by Vivado on Thu Nov 13 11:42:18 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_deserializer_vhdl.prj"
call xvhdl  --incr --relax -prj tb_deserializer_vhdl.prj -log xvhdl.log
